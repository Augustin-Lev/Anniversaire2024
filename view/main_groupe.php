<main class="fond_fonce">
    ...
    <div class="main_groupe">
        <h1 class="ecriture_claire">Pour avoir les infos !</h1>  
        <div class="ecriture_claire">
        ...
        <div>
            <p class="ecriture_claire bandeau-tel">
                Afin de vous tenir au courant, vous pouvez rejoindre le groupe whatsapp suivant. N'hésitez pas à nous contactez personellement aussi ;)
            </p>
        </div>
